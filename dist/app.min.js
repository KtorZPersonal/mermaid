...
var $author$project$OAuth$Implicit$Empty = {$: 'Empty'};
...
var $author$project$Main$parsers = {authorizationErrorParser: $author$project$OAuth$Implicit$defaultAuthorizationErrorParser, authorizationSuccessParser: $author$project$OAuth$Implicit$defaultAuthorizationSuccessParser, errorParser: $author$project$Main$errorParser, tokenParser: $author$project$Main$tokenParser};
var $author$project$Main$patchUrl = function (url) {
	return (_Utils_eq(
		url.fragment,
		$elm$core$Maybe$Just('_=_')) || _Utils_eq(url.fragment, $elm$core$Maybe$Nothing)) ? _Utils_update(
		url,
		{fragment: url.query}) : url;
};
			...
			case 'Success':
				...
				if (mflags.$ === 'Nothing') {
					...
					return (!_Utils_eq(
						...
						{
							flow: $author$project$Main$Authorized(
								A2($elm$core$Debug$log, 'AccessToken', token)),
							redirectUri: redirectUri
						},
...
var $author$project$Main$configuration = {
	authorizationEndpoint: _Utils_update(
		...
		{host: 'facebook.com', path: '/v6.0/dialog/oauth'}),
	clientId: '179456896198275',
	scope: _List_Nil,
	userInfoDecoder: A3(
		$elm$json$Json$Decode$map2,
		$author$project$Main$UserInfo,
		A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'profile_pic', $elm$json$Json$Decode$string)),
	userInfoEndpoint: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{host: 'graph.facebook.com', path: '/v3.1/me'})
};
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $author$project$Internal$Token = {$: 'Token'};
...
var $author$project$Internal$makeRedirectUri = function (url) {
	return $elm$core$String$concat(
		_List_fromArray(
			[
				$author$project$Internal$protocolToString(url.protocol),
				'://',
				url.host,
				A2(
				$elm$core$Maybe$withDefault,
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		view: $author$project$Main$view(
			{
				btnClass: $elm$html$Html$Attributes$class('btn-facebook'),
